      ...
      <el-main>
        <el-form :model="form" :label-position="'top'" ref="form">
          ...
          <el-space direction="vertical" fill wrap style="width: 100%">
            <el-divider content-position="right" v-if="form.endereco"
              >Endereço
            ...
            <el-divider content-position="right" v-if="form.filiacao"
              >Filiação
            ...
            <el-divider v-if="form.trabalho" content-position="right"
              >Trabalho
            ...
            <el-collapse-transition>
              <FormProfissao
                v-if="exibeTrabalho"
                v-model="form.trabalho"
              ></FormProfissao>
            </el-collapse-transition>
          </el-space>
        </el-form>
        <div style="margin-top: 20px"><slot></slot></div>
      </el-main>
    </el-container>
  </el-card>
</template>
